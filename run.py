...
def train(args):
    ...
    tr_data = ImageDataGenerator('/data/Biased_CelebA_0927/biased_celeba_train.txt',
                                 dataroot='/data/Biased_CelebA_0927/',
                                 mode='training',
                                 batch_size=args.batch_size,
                                 num_classes=num_classes,
                                 shuffle=True)
    val_data = ImageDataGenerator('/data/Biased_CelebA_0927/biased_celeba_val.txt',
                                  dataroot='/data/Biased_CelebA_0927/',
                                  mode='inference',
                                  batch_size=args.batch_size,
                                  num_classes=num_classes,
                                  shuffle=False)
    val_data_bias = ImageDataGenerator('/data/Biased_CelebA_0927/biased_celeba_val_bias.txt',
                                  dataroot='/data/Biased_CelebA_0927/',
                                  mode='inference',
                                  batch_size=args.batch_size,
                                  num_classes=num_classes,
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(args.epochs):
            ...
            if (epoch + 1) % 10 == 0:
                ckpt_file = os.path.join(args.ckpt_dir, 'celeba_model.ckpt')
